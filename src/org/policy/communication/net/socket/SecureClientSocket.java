 ...
 * 
 * </p><p>
 * $Id: SecureClientSocket.java,v 1.1 2007/02/17 16:59:27 dolmedilla Exp $
 * <br/>
 * Date: 05-Dec-2003
 * <br/>
 ...
 * @author olmedilla 
 */
public class SecureClientSocket implements NetworkClient {
...
//  	public static final String STORE_PASSWORD = "clientstorepw" ;
	...
	public SecureClientSocket(String keystoreFile, String keyPassword, String storePassword) {
		log.debug("$Id: SecureClientSocket.java,v 1.1 2007/02/17 16:59:27 dolmedilla Exp $");
	...
	public void send(ServiceMessage message, NetworkPeer peer)
	{
		...
		SecureSocketPeer socketPeer = (SecureSocketPeer) peer ;
		...
		socket = null ;
			...
			try {
				...
				socket = (SSLSocket) _sf.createSocket(socketPeer.getAddress(), socketPeer.getPort()) ;
