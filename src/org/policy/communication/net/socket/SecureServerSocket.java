...
import org.policy.crypt.CryptTools;

/**
 * <p>
 * 
 * </p><p>
 * $Id: SecureServerSocket.java,v 1.1 2007/02/17 16:59:27 dolmedilla Exp $
 * <br/>
 * Date: 05-Dec-2003
 * <br/>
 ...
 * @author olmedilla 
 */
public class SecureServerSocket implements NetworkServer {
...
//   private String storePassword ;
   private SSLServerSocket _ss = null;
	...
	public SecureServerSocket(int port, String keystoreFile, String keyPassword, String storePassword) {
		log.debug("$Id: SecureServerSocket.java,v 1.1 2007/02/17 16:59:27 dolmedilla Exp $");
		...
		{	
			...
			try
			{
				...
				try {
					...
					ServiceMessage message = (ServiceMessage) objIn.readObject() ;
