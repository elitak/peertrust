 ...
 * filter. 
 * </p><p>
 * $Id: LDAPWrapper.java,v 1.1 2006/08/10 10:10:35 dolmedilla Exp $
 * <br/>
 * Date: 22-JUN-2006
 * <br/>
...
public class LDAPWrapper extends AbstractExecutorWrapper {
	...
	public ActionResult executeAction(final String functionName,
			final String[] arguments, final String[] inputVars) throws FunctionFailureException, NoSuchFunctionException, IllegalArgumentException
			 {
...
//		 Create the default search controls
	...
	// Zum Sicher, dass wenn eingabe noch leerzeichen enthält	
...
//		 and the "mail" attribute
	//vom Parser wird "(" & ")" Zeichen als andere bedeutung erkannt, Deswegen werden in Anfrage mit "[" & "]" ersetzen, hier werden zurücksetzen	
