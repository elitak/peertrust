...
public abstract class AbstractExecutorWrapper implements ExecutablePackage {
	...
	// TODO Review this class. Seems wrong
	
	public abstract ActionResult localExecuteAction(
			final ActionRequest actionRequest) throws IllegalArgumentException, FunctionFailureException,
