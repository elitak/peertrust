 ...
 * </p><p>
 * $Id: TNSeqDiagramm.java,v 1.9 2005/08/07 12:06:52 dolmedilla Exp $
 * <br/>
 * Date: 10-Feb-2005
 * <br/>
...
public class TNSeqDiagramm {
    ...
    private String createNode(Object object, String peerAddress,
        ...
        GraphConstants.setBorderColor(nodeAttributes, graphics
                .getNodeBorderColor());
        GraphConstants.setBackground(nodeAttributes, graphics
    ...
    private String connectNodes(TNNode nodeSource, TNNode nodeTarget,
        ...
        GraphConstants.setMoveable(edgeInvisibleSourceAttributes, graphics
                .getEdgeMovable());
        GraphConstants.setConnectable(edgeInvisibleSourceAttributes, graphics
                .getEdgeMovable());
        GraphConstants.setDisconnectable(edgeInvisibleSourceAttributes,
                graphics.getEdgeMovable());
        GraphConstants.setBendable(edgeInvisibleSourceAttributes, graphics
                .getEdgeMovable());
        GraphConstants.setSizeable(edgeInvisibleSourceAttributes, graphics
                .getEdgeMovable());
        GraphConstants.setEditable(edgeInvisibleSourceAttributes, graphics
                .getEdgeEditable());
        GraphConstants.setLineColor(edgeInvisibleSourceAttributes, graphics
                .getEdgeColor());
        ...
        GraphConstants.setMoveable(edgeInvisibleTargetAttributes, graphics
                .getEdgeMovable());
        GraphConstants.setConnectable(edgeInvisibleTargetAttributes, graphics
                .getEdgeMovable());
        GraphConstants.setDisconnectable(edgeInvisibleTargetAttributes,
                graphics.getEdgeMovable());
        GraphConstants.setBendable(edgeInvisibleTargetAttributes, graphics
                .getEdgeMovable());
        GraphConstants.setSizeable(edgeInvisibleTargetAttributes, graphics
                .getEdgeMovable());
        GraphConstants.setEditable(edgeInvisibleTargetAttributes, graphics
                .getEdgeEditable());
        GraphConstants.setLineColor(edgeInvisibleTargetAttributes, graphics
                .getEdgeColor());
        ...
        GraphConstants
                .setConnectable(edgeAttributes, graphics.getEdgeMovable());
        GraphConstants.setDisconnectable(edgeAttributes, graphics
                .getEdgeMovable());
