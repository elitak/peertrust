 ...
 * </p><p>
 * $Id: PeerTrustGrammar.java,v 1.2 2005/08/07 12:06:54 dolmedilla Exp $
 * <br/>
 * Date: 15-Aug-2004
 * <br/>
...
throws ParseException, java.io.IOException
{
  ...
  public static void main(String[] args) throws FileNotFoundException, ParseException, IOException
  {
  	...
  	if (args.length != 2)
  	{
  		System.out.println ("usage: program <inputFile> <outputFile>") ;
  		System.exit(1) ;
  	}
  	
  	System.out.println ("Converting peertrust rules from " + args[0]) ;
  	
  	PeerTrustGrammar.ConvertRules(args[0], args[1]) ;
  	
  	System.out.println ("Conversion stored in " + args[1]) ;
  }
