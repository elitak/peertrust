 ...
 * <li>the peer proves it is the owner of the private key associated to <tt>K</tt></li>
 * <li><tt>X</tt> is recorded into <tt>logfile_name</tt></li>
 * </ol>
 * These provisional predicates trigger some events (resp. the sending of a credential/desclaration,
