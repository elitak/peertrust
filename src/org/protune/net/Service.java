 ...
 * all the issues related to the communication with the client, hopefully hiding the complexity
 * requested by the network communication and allowing the programmer to focus on the application by
 * simply incapsulating the application logic in a subclass of <tt>Service</tt>.
