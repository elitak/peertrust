...
<body>
	...
	<div class="main_display">	
		<strong>
		Demo Tree Visualization High Resolution<strong>
		<br>
		<div style="position: relative; top: 0px; left: 0px: width: 1280px: height: 1024px:">
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="1280" height="1024">
				<param name="movie" value="demo/swf/demoTreeHigh.swf">
				<param name="quality" value="high"> <param name="LOOP" value="false">
				<embed src="demo/swf/demoTreeHigh.swf" width="1280" height="1024" loop="false" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash">				
				</embed>
			</object>
		</div>
	</div>
