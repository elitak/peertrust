 ...
 *
 */
public class ElseExhibitNoAttribute extends ExhibitAttributeTag {
	...
	public int doStartTag() throws JspException {
		System.out.println("ElseExhibitNoAttributeTag.doStartTag");
		//check parent
		...
		if(((PTNegotiableContentTag)parentTag).elseExibitsNoAttribute()){
