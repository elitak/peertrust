 ...
 *
 */
public class IfExhibitAttributeTag extends ExhibitAttributeTag {
	...
	public int doStartTag() throws JspException {
		System.out.println("IfExhibitAttributeTag.doStartTag()");
		//check parent
		...
		if(((PTNegotiableContentTag)parentTag).ifExibitsAttribute(getName(),getValue())){
