...
import g4mfs.impl.org.peertrust.config.*;

/**
 * <p>
 * Main class in charge of seting up the whole Security Agent.
 * </p><p>
 * $Id: PTEngine.java,v 1.1 2005/11/30 10:35:17 ionut_con Exp $
 * <br/>
 * Date: 05-Dec-2003
 * <br/>
...
//	private PTConfigurator _configurator ;
	...
	public PTEngine() {
		super();
		log.debug("$Id: PTEngine.java,v 1.1 2005/11/30 10:35:17 ionut_con Exp $");
	}
