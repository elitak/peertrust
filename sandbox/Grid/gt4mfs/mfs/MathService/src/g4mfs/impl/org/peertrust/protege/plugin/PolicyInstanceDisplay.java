 ...
 * </p><p>
 * $Id: PolicyInstanceDisplay.java,v 1.1 2005/11/30 10:35:15 ionut_con Exp $
 * <br/>
 * Date: 30-Oct-2004
 * <br/>
...
//            		_currentWidget.getClass().getName());
    ...
    private Action createCreateYellowStickiesAction() {
    	//not in 3.0
        return new AbstractAction("Create Note", Icons.getCreateClsNoteIcon()){//;getCreateYellowStickyIcon()) {
    ...
    private Action createDeleteYellowStickiesAction() {
        return new AbstractAction("Delete Note", Icons.getDeleteClsNoteIcon()){//getDeleteYellowStickyIcon()) {
            public void actionPerformed(ActionEvent event) {
                deleteYellowSticky();
            }
        };
    ...
    private JComponent createHeader() {
        ...
        //FakeToolBar toolBar = ComponentFactory.createFakeToolBar((ComponentFactory.STANDARD_BUTTON_SIZE);//SMALL_BUTTON_SIZE);
