/**
 * MathFactoryPortTypeSOAPBindingStub.java
 *
...
public class MathFactoryPortTypeSOAPBindingStub extends org.apache.axis.client.Stub implements g4mfs.stubs.MathFactoryPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(new javax.xml.namespace.QName("http://www.globus.org/gt4ide/example/MathFactoryService", "createResource"), new javax.xml.namespace.QName("http://www.globus.org/gt4ide/example/MathFactoryService", ">createResource"), g4mfs.stubs.CreateResource.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.globus.org/gt4ide/example/MathFactoryService", ">createResourceResponse"));
        oper.setReturnClass(g4mfs.stubs.CreateResourceResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://www.globus.org/gt4ide/example/MathFactoryService", "createResourceResponse"));
    ...
    public MathFactoryPortTypeSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public MathFactoryPortTypeSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public MathFactoryPortTypeSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            qName = new javax.xml.namespace.QName("http://www.globus.org/gt4ide/example/MathFactoryService", ">createResource");
            cachedSerQNames.add(qName);
            cls = g4mfs.stubs.CreateResource.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.globus.org/gt4ide/example/MathFactoryService", ">createResourceResponse");
            cachedSerQNames.add(qName);
            cls = g4mfs.stubs.CreateResourceResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public g4mfs.stubs.CreateResourceResponse createResource(g4mfs.stubs.CreateResource request) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPActionURI("http://www.globus.org/gt4ide/example/MathFactoryService/MathFactoryPortType/createResourceRequest");
        _call.setEncodingStyle(null);
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (g4mfs.stubs.CreateResourceResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (g4mfs.stubs.CreateResourceResponse) org.apache.axis.utils.JavaUtils.convert(_resp, g4mfs.stubs.CreateResourceResponse.class);
            }
        }
    }
