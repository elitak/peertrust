...
/**
 * As stated in {@link org.protune.core.Status}, a negotiation state should
 * contain (at least)
 * <ul>
 * <li>sent/received {@link org.protune.api.FilteredPolicy}</li>
 * <li>{@link org.protune.api.Notification} of performed actions</li>
 * <li>{@link org.protune.api.Check} testing whether the notifications are
 * (not) reliable</li>
 * </ul>
 * When inserted into a state, such entities are decorated with other
 * information which are meant to support advanced features. At present this
 ...
 * </ul>
 * A <tt>NegotiationElement</tt> object is a wrapper for these entities
...
public class NegotiationElement {
	...
	/**
	 * Returns whether the entity contained in the negotiation element (namely
	 * {@link org.protune.api.FilteredPolicy},
	 * {@link org.protune.api.Notification} or {@link org.protune.api.Check})
	 * was sent or received.
	 * 
	 * @return <tt>true</tt> if the entity contained in the negotiation
	 *         element was sent, <tt>false</tt> otherwise.
	 */
	 ...
	 * 
	 * @return <tt>true</tt> if the entity contained in the negotiation
	 *         element was received, <tt>false</tt> otherwise.
	 */
	...
	/**
	 * Returns when the entity contained in the negotiation element (namely
	 * {@link org.protune.api.FilteredPolicy},
	 * {@link org.protune.api.Notification} or {@link org.protune.api.Check})
	 * was added to the state.
	 * 
	 * @return When the entity contained in the negotiation element was added to
	 *         the state.
	 */
	...
	/**
	 * Returns the number of the negotiation step during which the entity
	 * contained in the negotiation element (namely
	 * {@link org.protune.api.FilteredPolicy},
	 * {@link org.protune.api.Notification} or {@link org.protune.api.Check})
	 * was added.
	 * 
	 * @return The number of the negotiation step during which the entity
	 *         contained in the negotiation element was added.
	 */
	 ...
	 * org.protune.api.FilteredPolicy}, {@link org.protune.api.Notification} or
	 * {@link org.protune.api.Check}).
	 * 
