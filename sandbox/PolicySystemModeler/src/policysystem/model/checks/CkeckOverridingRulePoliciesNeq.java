package policysystem.model.checks;

import policysystem.model.PSModelCheck;
...
public class CkeckOverridingRulePoliciesNeq implements PSModelCheck 
{
	...
	/**
	 * @see policysystem.model.PSModelCheck#doCheck()
	 */
	...
	/**
	 * @see policysystem.model.PSModelCheck#getMessage()
	 */
