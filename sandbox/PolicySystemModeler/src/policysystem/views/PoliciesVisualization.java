...
public class PoliciesVisualization extends Page implements GraphSelectionListener,
	...
	private GraphSelectionProvider graphSelectionProvider=
										new GraphSelectionProvider();
	//
	// Main
	//
...
//		frame.setVisible(true);
	...
	public PoliciesVisualization() 
	{
		...
		hierarchyNodeCreationMechanism=
				PolicySystemRDFModel.resourceHierarchyCreationMechanism;
		// Construct the Graph
		graph = createGraph();
