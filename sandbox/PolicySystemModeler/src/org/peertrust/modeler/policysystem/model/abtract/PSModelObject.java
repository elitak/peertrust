...
public interface PSModelObject 
{
	 ...
	 */
	public static final String ROLE_ORULE_OVERRIDDER=
											"ROLE_ORULE_OVERRIDDER";
	
	/**
	 * The key for the overridden policy in an overriding rule
	 */
	public static final String ROLE_ORULE_OVERRIDDEN=
											"ROLE_ORULE_OVERRIDDEN";
	
	/**
	 * To get the wrapped model object
	 * @return the original model object
	 */
	public Object getModelObject();
	
	/**
	 * To get the label of the model object
