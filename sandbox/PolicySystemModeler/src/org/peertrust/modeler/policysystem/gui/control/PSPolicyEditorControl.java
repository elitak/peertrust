...
public class PSPolicyEditorControl implements PSModelObjectEditControl
{
	...
	/**
	 * Check whether the new value sustisfyies the integrity constrainst
	 */
	...
	/* (non-Javadoc)
	 * @see org.peertrust.modeler.policysystem.gui.control.PSModelObjectEditControl#createControl(org.eclipse.swt.widgets.Composite)
	 */
	...
	/* (non-Javadoc)
	 * @see org.peertrust.modeler.policysystem.gui.control.PSModelObjectEditControl#getControl()
	 */
