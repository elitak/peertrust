...
/**
 * $Id: LogicAnswer.java,v 1.1 2004/08/07 12:51:54 magik Exp $
 * 
 * @author olmedilla
...
public class LogicAnswer {
    ...
    public LogicAnswer(String goal, String goalExpanded, String subgoals,
            String proof, String delegator) {
        this.goal = goal;
    ...
    public String toString() {
        return "Goal: |" + goal + "| - Subgoals: |" + subgoals + "| - Proof: |"
                + proof + "|";
    }
