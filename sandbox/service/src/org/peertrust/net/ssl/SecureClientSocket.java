...
/**
 * $Id: SecureClientSocket.java,v 1.1 2004/08/07 12:51:56 magik Exp $
 * 
 * @author olmedilla
...
public class SecureClientSocket implements NetClient {
    ...
    public SecureClientSocket(String keystoreFile, String keyPassword,
     ...
     * (non-Javadoc)
     * 
     * @see org.peertrust.net.NetClient#send(org.peertrust.net.Message,
     *      org.peertrust.net.Peer)
     */
    /**
     * @param obj
     */
    public void send(Message message, Peer peer) {
        ...
        try {
            ...
            socket = (SSLSocket) sf.createSocket(peer.getAddress(), peer
                    .getPort());

            //				((SSLSocket)socket).addHandshakeCompletedListener(new
            ...
            // event.getSession().getPeerCertificateChain() ;
    ...
    //	{
    //		SecureClientSocket sc = new SecureClientSocket("testClient_keystore",
    // "testkey", "testkey") ;
    //		
    //		sc.send(new Query (null, new Peer(null, null, 12), 12), new Peer
    // ("alice", "localhost", 35000)) ;
    //		
