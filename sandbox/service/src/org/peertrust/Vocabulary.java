...
/**
 * $Id: Vocabulary.java,v 1.1 2004/08/07 12:51:57 magik Exp $
 * 
 * @author olmedilla
...
public class Vocabulary {
    ...
    public static final String KEYSTORE_FILE_TAG = METAI_PREFIX
            + "keystoreFile";

    public static final String KEY_PASSWORD_TAG = METAI_PREFIX + "keyPassword";

    public static final String STORE_PASSWORD_TAG = METAI_PREFIX
            + "storePassword";
}