 ...
 * allows creation and persistant storage of credentials as well as a convinient
 * method for accessing the information of the stored Credentials.
 * 
 * @author Eric Knauss
 */
public class X509CredentialStore extends CredentialStore {
    ...
    public X509CredentialStore(String file, String storePassword)
            throws Exception {
        super();
        this.file = file;
    ...
    public X509CredentialStore(String storePassword) throws KeyStoreException,
    ...
    public void loadAllCredentialsFromFile(String file)
    ...
    private void createEmptyStore() throws KeyStoreException,
            NoSuchAlgorithmException, CertificateException, IOException {
        ks = KeyStore.getInstance("JKS");
