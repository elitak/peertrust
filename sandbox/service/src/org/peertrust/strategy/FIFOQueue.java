...
/**
 * $Id: FIFOQueue.java,v 1.1 2004/08/07 12:51:57 magik Exp $
 * 
 * @author olmedilla
 * @date 05-Dec-2003 Last changed $Date: 2004/08/07 12:51:57 $ by $Author:
 *       dolmedilla $
 * @description
 */
public class FIFOQueue implements Queue {
    ...
    /**
     * @see org.peertrust.strategy.Queue#update(trust.meta.Tree,
     *      trust.meta.Tree)
     */
    ...
    /**
     * @see org.peertrust.strategy.Queue#replace(trust.meta.Tree,
     *      trust.meta.Tree)
     */
