...
public class SaveAsRDFAction extends Action implements IWorkbenchAction,
	ISelectionListener {
	...
	public SaveAsRDFAction(IWorkbenchWindow window) {
		this.window=window;
		setId(ID);
		setText("&Export to RDF File");
		setToolTipText("Export to RDF File");
