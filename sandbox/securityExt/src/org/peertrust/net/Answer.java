...
/**
 * $Id: Answer.java,v 1.1 2004/12/21 11:09:35 seb0815 Exp $
 * @author olmedilla
 * @date 05-Dec-2003
...
public class Answer extends Message implements Serializable {
	...
	public Answer(String goal, Vector proof, int status, long reqQueryId, Peer delegator) {
		super(delegator) ;
		this.goal = goal ;
	 ...
	 * @param Vector The new proof tree-Vector.
	 */
	public void setProofRuleVector(Vector vector) {
		vectorProofRules.clear();
		vectorProofRules.addAll(vector);
	}
